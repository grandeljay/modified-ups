...
class Field
{
    ...
    public static function surchargesSurcharges(string $value, string $option): string
    {
        ...
        $for_methods = [
            ...
            'express'    => Constants::MODULE_SHIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAMEIPPING_NAME . '_SHIPPING_METHOD_EXPRESS',
