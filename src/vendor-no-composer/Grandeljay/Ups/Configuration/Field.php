...
class Field
{
    ...
    public static function getShippingNationalMethodCosts(): array
    {
        ...
        $national_costs = array(
            Group::SHIPPING_NATIONAL . '_STANDARD' => array(
                'costs' => json_encode($national_costs_standard),
                'kg'    => '0.33',
                'min'   => '3.40',
            ),
            Group::SHIPPING_NATIONAL . '_SAVER'    => array(
                'costs' => json_encode($national_costs_saver),
                'kg'    => '0.42',
                'min'   => '4.50',
            ),
            Group::SHIPPING_NATIONAL . '_1200'     => array(
                'costs' => json_encode($national_costs_1200),
                'kg'    => '0.50',
                'min'   => '5.45',
            ),
            Group::SHIPPING_NATIONAL . '_EXPRESS'  => array(
                'costs' => json_encode($national_costs_express),
                'kg'    => '0.61',
                'min'   => '6.60',
            ),
            Group::SHIPPING_NATIONAL . '_PLUS'     => array(
    ...
    public static function shippingMethodCosts(string $value, string $option): string
    {
        ...
        <dialog id="<?= $option ?>">
                        ...
                        <tr class="infoBoxContent">
                            <td class="infoBoxContent">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <button name="grandeljayups_add" type="button"><?= constant(\grandeljayups::NAME . '_BUTTON_ADD') ?></button>
                                    </div>
                                </div>
                            </td>
                        </tr>
            ...
            <div class="buttons">
                <button name="grandeljayups_apply" value="default" type="button"><?= constant(\grandeljayups::NAME . '_BUTTON_APPLY') ?></button>
                <button name="grandeljayups_cancel" value="cancel" type="button"><?= constant(\grandeljayups::NAME . '_BUTTON_CANCEL') ?></button>
            </div>
        </dialog>
        <?php
        $html .= ob_get_clean();
    ...
    public static function getShippingCountryGroupACosts(): array
    {
        ...
        $group_a_costs = array(
            Group::SHIPPING_GROUP_A . '_STANDARD' => array(
                'costs' => json_encode($group_a_costs_standard),
                'kg'    => '0.33',
                'min'   => '3.40',
            ),
            Group::SHIPPING_GROUP_A . '_SAVER'    => array(
                'costs' => json_encode($group_a_costs_saver),
                'kg'    => '0.42',
                'min'   => '4.50',
            ),
            Group::SHIPPING_GROUP_A . '_EXPRESS'  => array(
                'costs' => json_encode($group_a_costs_express),
                'kg'    => '0.61',
                'min'   => '6.60',
            ),
            Group::SHIPPING_GROUP_A . '_PLUS'     => array(
    ...
    public static function getShippingCountryGroupBCosts(): array
    {
        ...
        $group_b_costs = array(
            Group::SHIPPING_GROUP_B . '_STANDARD' => array(
                'costs' => json_encode($group_b_costs_standard),
                'kg'    => '0.60',
                'min'   => '5.65',
            ),
            Group::SHIPPING_GROUP_B . '_SAVER'    => array(
                'costs' => json_encode($group_b_costs_saver),
                'kg'    => '1.92',
                'min'   => '11.90',
            ),
            Group::SHIPPING_GROUP_B . '_EXPRESS'  => array(
                'costs' => json_encode($group_b_costs_express),
                'kg'    => '2.20',
                'min'   => '13.90',
            ),
            Group::SHIPPING_GROUP_B . '_PLUS'     => array(
    ...
    public static function getShippingCountryGroupCCosts(): array
    {
        ...
        $group_c_costs = array(
            Group::SHIPPING_GROUP_C . '_STANDARD' => array(
                'costs' => json_encode($group_c_costs_standard),
                'kg'    => '0.69',
                'min'   => '5.65',
            ),
            Group::SHIPPING_GROUP_C . '_SAVER'    => array(
                'costs' => json_encode($group_c_costs_saver),
                'kg'    => '2.41',
                'min'   => '11.90',
            ),
            Group::SHIPPING_GROUP_C . '_EXPRESS'  => array(
                'costs' => json_encode($group_c_costs_express),
                'kg'    => '2.79',
                'min'   => '13.90',
            ),
            Group::SHIPPING_GROUP_C . '_PLUS'     => array(
    ...
    public static function getShippingCountryGroupDCosts(): array
    {
        ...
        $group_d_costs = array(
            Group::SHIPPING_GROUP_D . '_STANDARD' => array(
                'costs' => json_encode($group_d_costs_standard),
                'kg'    => '0.88',
                'min'   => '9.90',
            ),
            Group::SHIPPING_GROUP_D . '_SAVER'    => array(
                'costs' => json_encode($group_d_costs_saver),
                'kg'    => '2.48',
                'min'   => '15.90',
            ),
            Group::SHIPPING_GROUP_D . '_EXPRESS'  => array(
                'costs' => json_encode($group_d_costs_express),
                'kg'    => '2.94',
                'min'   => '18.90',
            ),
            Group::SHIPPING_GROUP_D . '_PLUS'     => array(
    ...
    public static function getShippingCountryGroupECosts(): array
    {
        ...
        $group_e_costs = array(
            Group::SHIPPING_GROUP_E . '_EXPEDITED' => array(
                'costs' => json_encode($group_e_costs_expedited),
                'kg'    => '4.92',
                'min'   => '15.90',
            ),
            Group::SHIPPING_GROUP_E . '_SAVER'     => array(
                'costs' => json_encode($group_e_costs_saver),
                'kg'    => '5.20',
                'min'   => '15.90',
            ),
            Group::SHIPPING_GROUP_E . '_EXPRESS'   => array(
                'costs' => json_encode($group_e_costs_express),
                'kg'    => '6.20',
                'min'   => '18.90',
            ),
            Group::SHIPPING_GROUP_E . '_PLUS'      => array(
    ...
    public static function getShippingCountryGroupFCosts(): array
    {
        ...
        $group_f_costs = array(
            Group::SHIPPING_GROUP_F . '_EXPEDITED' => array(
                'costs' => json_encode($group_f_costs_expedited),
                'kg'    => '7.04',
                'min'   => '15.90',
            ),
            Group::SHIPPING_GROUP_F . '_SAVER'     => array(
                'costs' => json_encode($group_f_costs_saver),
                'kg'    => '7.32',
                'min'   => '15.90',
            ),
            Group::SHIPPING_GROUP_F . '_EXPRESS'   => array(
                'costs' => json_encode($group_f_costs_express),
                'kg'    => '8.17',
                'min'   => '18.90',
            ),
            Group::SHIPPING_GROUP_F . '_PLUS'      => array(
    ...
    public static function surchargesSurcharges(string $value, string $option): string
    {
        ...
        $for_methods = array(
            'all'        => \grandeljayups::NAME . '_' . Group::SURCHARGES . '_FOR_METHOD_ALL',
            'all-others' => \grandeljayups::NAME . '_' . Group::SURCHARGES . '_FOR_METHOD_ALL_OTHERS',
            'standard'   => \grandeljayups::NAME . '_SHIPPING_METHOD_STANDARD',
            'expedited'  => \grandeljayups::NAME . '_SHIPPING_METHOD_EXPEDITED',
            'saver'      => \grandeljayups::NAME . '_SHIPPING_METHOD_SAVER',
            '1200'       => \grandeljayups::NAME . '_SHIPPING_METHOD_1200',
            'express'    => \grandeljayups::NAME . '_SHIPPING_METHOD_EXPRESS',
            'plus'       => \grandeljayups::NAME . '_SHIPPING_METHOD_PLUS',
        );
            ...
            <div class="modulbox">
                <table class="contentTable">
                    <tbody>
                        <tr class="infoBoxHeading">
                            <td class="infoBoxHeading">
                                <div class="infoBoxHeadingTitle"><b><?= constant(\grandeljayups::NAME . '_SURCHARGES_SURCHARGES_TITLE') ?></b></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <td class="infoBoxContent">
                                <div class="container">
                                    <template id="grandeljayups_row">
                                        <div class="row">
                                            ...
                                            <div class="column type">
                                                <select name="type">
                                                    <option value="fixed"><?= constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_FIXED') ?></option>
                                                    <option value="percent"><?= constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_PERCENT') ?></option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="column name">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_NAME_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_NAME_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column amount">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_SURCHARGE_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_SURCHARGE_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column type">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column per-package select-option">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_PER_PACKAGE_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_PER_PACKAGE_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column for-weight">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_FOR_WEIGHT_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_FOR_WEIGHT_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column for-method">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_FOR_METHOD_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_FOR_METHOD_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column duration-start">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_DURATION_START_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_DURATION_START_DESC') ?><br>
                                            </div>
                                        </div>

                                        <div class="column duration-end">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_SURCHARGES_DURATION_END_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_SURCHARGES_DURATION_END_DESC') ?><br>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php foreach ($surcharges as $surcharge_index => $surcharge) { ?>
                                        <div class="row">
                                            ...
                                            <div class="column type">
                                                <select name="type">
                                                    <?php
                                                    $fixedText   = constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_FIXED');
                                                    $percentText = constant(\grandeljayups::NAME . '_SURCHARGES_TYPE_PERCENT');
                                                    $types       = array(
                                                        'fixed'   => $fixedText,
                                                        'percent' => $percentText,
                                                    );
            ...
            <div class="modulbox">
                <table class="contentTable">
                    <tbody>
                        <tr class="infoBoxHeading">
                            <td class="infoBoxHeading">
                                <div class="infoBoxHeadingTitle"><b><?= constant(\grandeljayups::NAME . '_SURCHARGES_PICK_AND_PACK_TITLE') ?></b></div>
                            </td>
                        </tr>
                    </tbody>
                </table>
                            ...
                            <td class="infoBoxContent">
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="column">
                                            <div>
                                                <b><?= constant(\grandeljayups::NAME . '_' . Group::SURCHARGES . '_PICK_AND_PACK_WEIGHT_HEAD_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_' . Group::SURCHARGES . '_PICK_AND_PACK_WEIGHT_HEAD_DESC') ?>
                                            </div>
                                        </div>

                                        <div class="column">
                                            <div>
                                            <b><?= constant(\grandeljayups::NAME . '_' . Group::SURCHARGES . '_PICK_AND_PACK_COSTS_HEAD_TITLE') ?></b><br>
                                                <?= constant(\grandeljayups::NAME . '_' . Group::SURCHARGES . '_PICK_AND_PACK_COSTS_HEAD_DESC') ?>
                                            </div>
                                        </div>
                                    </div>
